...
/* 
 * classe correspondente ao formulário de atualização.
 * O tratamento do evento do botão salvar ocorre de forma similar ao mesmo botão do
 * formulário de inserção. Porém, como o id do contato não pode ser alterado, apenas os demais
 * dados, não é necessário fazer uma consulta na base de dados para reconstruir a tabela. Para a
 * atualização da linha referente ao contato editado, a mesma é excluída e adicionada com os
 * novos dados. Isso é possível com a utilização dos métodos removeRow e addRow.
 */
